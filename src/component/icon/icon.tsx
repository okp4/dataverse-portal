...
import { ReactComponent as DraftIcon } from '@/asset/icon/draft.svg'
import { ReactComponent as TopicIcon } from '@/asset/icon/topic.svg'
import { ReactComponent as EventIcon } from '@/asset/icon/event.svg'
import { ReactComponent as PublicIcon } from '@/asset/icon/public.svg'
import { ReactComponent as ShieldIcon } from '@/asset/icon/shield.svg'
